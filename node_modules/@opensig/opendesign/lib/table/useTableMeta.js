...
function useTableMeta(elRef, options = {}) {
  ...
  vueUtils.resolveHtmlElement(elRef).then((el) => {
    if (!(el instanceof HTMLTableElement)) {
      return;
    }
    updateMeta(el);
    const deBounceUpdateMeta = helper.debounce(updateMeta.bind(null, el), 16, false);
...
exports.DEFAULT_CELL_FIRST_COL_MARKER = DEFAULT_CELL_FIRST_COL_MARKER;
exports.DEFAULT_CELL_LAST_COL_MARKER = DEFAULT_CELL_LAST_COL_MARKER;
exports.DEFAULT_CELL_LAST_ROW_MARKER = DEFAULT_CELL_LAST_ROW_MARKER;
exports.DEFAULT_ROW_LAST_MARKER = DEFAULT_ROW_LAST_MARKER;
