...
.c-card-kunpeng.o-card {
  --card-shadow: none;
  --card-shadow-hover: none;
  --card-shadow-active: none;
  --card-radius: 0px;
  --card-cover-radius: 0px;
  --card-icon-size: 48px;
}
.c-card-kunpeng .o-card-cover-v.o-card-cover-v,
.c-card-kunpeng .o-card-cover-h.o-card-cover-h,
.c-card-kunpeng .o-card-cover-hr.o-card-cover-hr {
  --card-cover-padding: 0px;
}
.c-card-kunpeng.o-card-hoverable .o-card-icon {
  transition: color var(--o-duration-s) var(--o-easing-standard);
}
@media (hover: hover) {
  .c-card-kunpeng.o-card-hoverable:hover .o-card-icon,
  .c-card-kunpeng.o-card-hoverable:hover .o-card-title-icon {
    color: var(--o-color-main1);
  }
}
.c-card-kunpeng.o-card-hoverable.o-card-cursor-pointer .o-card-title {
  transition: color var(--o-duration-s) var(--o-easing-standard);
}
@media (hover: hover) {
  .c-card-kunpeng.o-card-hoverable.o-card-cursor-pointer:hover .o-card-title {
    color: var(--o-color-main1);
  }
}

@media (min-width: 841px) and (max-width: 1200px) {
  .c-card-kunpeng.o-card:not(.o-card-no-responsive) {
    --card-icon-size: var(--o-icon_size_control-xl);
  }
}
.c-card-kunpeng.o-card .o-card-cover-v .o-card-cover-img {
  border-top-left-radius: var(--card-cover-radius);
  border-top-right-radius: var(--card-cover-radius);
  border-bottom-left-radius: 0;
  border-bottom-right-radius: 0;
}
.c-card-kunpeng.o-card .o-card-cover-v .o-card-cover-img img {
  border-top-left-radius: var(--card-cover-radius);
  border-top-right-radius: var(--card-cover-radius);
  border-bottom-left-radius: 0;
  border-bottom-right-radius: 0;
}
.c-card-kunpeng.o-card .o-card-cover-h .o-card-cover-img {
  border-top-left-radius: var(--card-cover-radius);
  border-top-right-radius: 0;
  border-bottom-left-radius: var(--card-cover-radius);
  border-bottom-right-radius: 0;
}
.c-card-kunpeng.o-card .o-card-cover-h .o-card-cover-img img {
  border-top-left-radius: var(--card-cover-radius);
  border-top-right-radius: 0;
  border-bottom-left-radius: var(--card-cover-radius);
  border-bottom-right-radius: 0;
}
.c-card-kunpeng.o-card .o-card-cover-hr .o-card-cover-img {
  border-top-left-radius: 0;
  border-top-right-radius: var(--card-cover-radius);
  border-bottom-left-radius: 0;
  border-bottom-right-radius: var(--card-cover-radius);
}
.c-card-kunpeng.o-card .o-card-cover-hr .o-card-cover-img img {
  border-top-left-radius: 0;
  border-top-right-radius: var(--card-cover-radius);
  border-bottom-left-radius: 0;
  border-bottom-right-radius: var(--card-cover-radius);
...
.o-switch-checked {
  --switch-handler-bg-color: var(--o-color-control1-light);
}

[data-o-theme^="k."] {
  --o-color-main2-start-raw: 255, 153, 51;
  --o-color-main2-end-raw: 247, 77, 97;
}