...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels(types.monthRangePickerProps, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const {
      ...
      onFocus: baseOnFocus,
      notifyChange
    } = useRangePickerBase.useRangePickerBase({ props, mode: "month", start, end, emit: emits });
    const { t } = index.useI18n();
    const { isPhonePad } = useScreen.useScreen();
    const isResponding = vue.computed(() => !props.noResponsive && isPhonePad.value);
    const format = vue.computed(() => props.format ?? "YYYY-MM");
