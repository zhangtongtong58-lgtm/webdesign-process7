...
function useCalendar(params) {
  ...
  function makeCell(date, isCurrentMonth, _today) {
    ...
    const rangeState = isCurrentMonth ? utils.computeRangeState({ cell: date, unit: "day", ...resolveRangeDeps({ rangeStart, rangeEnd, anchorDate, hoverDate }) }) : NO_RANGE;
