...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels(types.dateRangePickerProps, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const {
      ...
      onFocus: baseOnFocus,
      notifyChange
    } = useRangePickerBase.useRangePickerBase({ props, mode: "date", start, end, emit: emits });
    ...
    const toDisplayStr = (ts) => {
      var _a;
      if (ts === void 0) return "";
      return ((_a = utils.parseValue(ts)) == null ? void 0 : _a.format(props.format)) ?? "";
    };
