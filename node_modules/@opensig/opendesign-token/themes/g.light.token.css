...
[data-o-theme="g.light"] {
   ...
   */
  --o-color-main2-start: rgb(var(--o-brand-5));
  /**
   * @name 
   * @type color
   * @group main
   ...
   */
  --o-color-main2-end: rgb(var(--o-brand-5));
  /**
   * @name 
   * @type color
   * @group main
   ...
   */
  --o-shadow-2: 0 2px 24px rgba(var(--o-grey-13), 0.15);
  /**
   * @name 阴影3
   * @type shadow
   * @group shadow
   * @description 用于提示阴影
   */
  --o-shadow-3: 0 8px 40px rgba(var(--o-grey-13), 0.1);
  /**
   * @name 间距1
   * @type gap
   * @group gap
