...
[data-o-theme="k.light"] {
   ...
   */
  --o-color-main2-start: rgb(255, 153, 51);
  /**
   * @name 
   * @type color
   * @group main
   ...
   */
  --o-color-main2-end: rgb(247, 77, 97);
  /**
   * @name 
   * @type color
   * @group main
   ...
   * @description 常规
   */
  --o-color-link1: rgb(var(--o-deepblue-6));
  /**
   * @name 
   * @type color
   * @group link
   * @description 悬浮
   */
  --o-color-link2: rgb(var(--o-deepblue-4));
  /**
   * @name 
   * @type color
   * @group link
   * @description 激活
   */
  --o-color-link3: rgb(var(--o-deepblue-7));
  /**
   * @name 
   * @type color
   * @group link
   * @description 禁用
   */
  --o-color-link4: rgb(var(--o-deepblue-3));
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control2: rgba(var(--o-grey-14), 0.6);
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control3: rgba(var(--o-grey-14), 0.8);
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control2-light: rgb(var(--o-grey-3));
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control3-light: rgb(var(--o-grey-4));
  /**
   * @name 
   * @type color
   * @group control
   ...
   * @description 常规
   */
  --o-color-primary1: rgb(var(--o-grey-12));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 悬浮
   */
  --o-color-primary2: rgb(var(--o-grey-11));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 激活
   */
  --o-color-primary3: rgb(var(--o-grey-13));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 禁用
   */
  --o-color-primary4: rgb(var(--o-grey-6));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 常规-浅
   */
  --o-color-primary1-light: rgb(var(--o-grey-4));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 悬浮-浅
   */
  --o-color-primary2-light: rgb(var(--o-grey-5));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 激活-浅
   */
  --o-color-primary3-light: rgb(var(--o-grey-6));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 禁用-浅
   */
  --o-color-primary4-light: rgb(var(--o-grey-5));
  /**
   * @name 
   * @type color
   * @group success
