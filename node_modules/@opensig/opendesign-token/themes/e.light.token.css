...
[data-o-theme="e.light"] {
   ...
   */
  --o-color-control4: rgba(var(--o-grey-14), 0.1);
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control5: rgb(var(--o-grey-1));
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control1-light: rgb(var(--o-grey-5));
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control2-light: rgb(var(--o-brand-1));
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control3-light: rgb(var(--o-brand-2));
  /**
   * @name 
   * @type color
   * @group control
   ...
   */
  --o-color-control4-light: rgb(var(--o-grey-3));
  /**
   * @name 
   * @type color
   * @group control
   * @description 悬浮面板背景色
   */
  --o-color-control5-light: rgb(var(--o-grey-1));
  /**
   * @name 
   * @type color
   * @group fill
   ...
   */
  --o-color-fill1: rgb(var(--o-grey-2));
  /**
   * @name 
   * @type color
   * @group fill
   ...
   */
  --o-color-fill2: rgb(var(--o-grey-1));
  /**
   * @name 
   * @type color
   * @group fill
   * @description 三级填充：卡片
   */
  --o-color-fill3: rgb(var(--o-grey-3));
  /**
   * @name 
   * @type color
   * @group primary
   ...
   * @description 全局遮罩
   */
  --o-color-mask1: rgba(var(--o-grey-14), 0.4);
  /**
   * @name 
   * @type color
   * @group mask
   * @description 局部遮罩
   */
  --o-color-mask2: rgba(var(--o-grey-1), 0.2);
  /**
   * @name 阴影1
   * @type shadow
   * @group shadow
   ...
   */
  --o-shadow-1: 0 3px 8px rgba(var(--o-grey-14), 0.08);
  /**
   * @name 阴影2
   * @type shadow
   * @group shadow
   ...
   */
  --o-shadow-2: 0 2px 24px rgba(var(--o-grey-14), 0.15);
  /**
   * @name 阴影3
   * @type shadow
   * @group shadow
   * @description 用于提示阴影
   */
  --o-shadow-3: 0 8px 40px rgba(var(--o-grey-14), 0.1);
  /**
   * @name 间距1
   * @type gap
   * @group gap
