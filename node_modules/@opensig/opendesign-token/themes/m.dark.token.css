...
[data-o-theme="m.dark"] {
   ...
   */
  --o-color-main2-start: rgb(7, 202, 255);
  /**
   * @name 
   * @type color
   * @group main
   ...
   */
  --o-color-main2-end: rgb(88, 130, 255);
  /**
   * @name 
   * @type color
   * @group main
