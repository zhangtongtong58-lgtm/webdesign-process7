...
[data-o-theme="a.dark"] {
   ...
   * @type color
   * @group main
   * @description 极光色-起始颜色
   */
  --o-color-main2-start: rgb(var(--o-deepblue-6));
  /**
   * @name 
   * @type color
   * @group main
   * @description 极光色-结束颜色
   */
  --o-color-main2-end: rgb(var(--o-purple-6));
  /**
   * @name 
   * @type color
   * @group main
   * @description 极光色-渐变角度
   */
   ...
   * @description 常规
   */
  --o-color-primary1: rgb(var(--o-grey-14));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 悬浮
   */
  --o-color-primary2: rgb(var(--o-grey-13));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 激活
   */
  --o-color-primary3: rgb(var(--o-grey-12));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 禁用
   */
  --o-color-primary4: rgb(var(--o-grey-8));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 常规-浅
   */
  --o-color-primary1-light: rgb(var(--o-grey-5));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 悬浮-浅
   */
  --o-color-primary2-light: rgb(var(--o-grey-6));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 激活-浅
   */
  --o-color-primary3-light: rgb(var(--o-grey-7));
  /**
   * @name 
   * @type color
   * @group primary
   * @description 禁用-浅
   */
  --o-color-primary4-light: rgb(var(--o-grey-6));
  /**
   * @name 
   * @type color
   * @group success
